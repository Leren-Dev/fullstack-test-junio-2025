    ...
    */
    api: {
      ...
      */
      ...
      |--------------------------------------------------------------------------
      |
      | The redis storage is suitable when API tokens are the primary mode of authentication.
      |
      | For example: You authenticate the requests from your mobile app using token-based authentication.
      |
      */
      /* tokenProvider: {
        type: 'api',
