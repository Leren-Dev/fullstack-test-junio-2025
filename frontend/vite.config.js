  ...
  plugins: [
        ...
        screenshots: [
          {
            ...
            sizes: "1906x972",
            type: "image/png",
            description: "A screenshot of an Store Dashboard",
          },
        ],
        ...
        shortcuts: [
          {
            ...
            description: "Visit my Store's Dashboard",
            url: "/dashboard",
            icons: [
              {
                src: "android/android-launchericon-192-192.png",
    ...
    }),
    {
      transformIndexHtml: {
        enforce: "pre",
        transform(html) {
          switch (env.VITE_USER_NODE_ENV) {
            case "production":
              html = readFileSync(path.resolve("./index.production.html"), {
                encoding: "utf8",
              });
              break;
            case "staging":
              html = readFileSync(path.resolve("./index.staging.html"), {
                encoding: "utf8",
              });
              break;
